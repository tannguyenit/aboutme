        ...
        <div class="modal-body">
            <form id="edit_cat" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="/admin/admin_cat/update">
                <div class="form-group">
                    ...
                    <input type="hidden" name="id_cat" value="<?php echo $arEdit["id_cat"]?>">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" class="form-control col-md-7 col-xs-12" name="tendm" value="<?php echo $arEdit['name']?>" > </div>
                </div>
