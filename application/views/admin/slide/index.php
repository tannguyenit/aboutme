...
<div class="col-xs-12">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-bars"></i> Quản lý ảnh slide</small></h2>
            ...
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <div id="myTabContent" class="tab-content">
									...
									foreach ($arSlide as $key => $value) {
										...
										<tr data-id=<?=$id?>>
											...
											<td style="width: 12%;text-align: center;">
												<a href="" data-toggle="modal" data-target=".bs-example-modal-lg" class="edit_slide"><i class="fa fa-edit"></i></a>
												<a href="/admin/admin_slide/del/<?php echo $value['id_slide']?>" title="" class="del_projects"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php $i++;}?>
								</tbody>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                        <form id="index_slide" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="/admin/admin_slide/add">
